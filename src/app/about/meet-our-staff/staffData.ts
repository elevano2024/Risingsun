export const staffList = [
  {
    ...
    details: [
      ...
      "RSMS prioritizes fostering student growth by encouraging self-paced learning, independent thinking and action, self-confidence, and strong relational skills that benefit students lifelong. It nurtures intrinsic motivation by empowering students to solve problems autonomously.  As a result, Rising Sun has established itself as one of the highest performing Charter Montessori schools in the state of California.",
      "Over the past decade, Rising Sun students have demonstrated that they are among the highest performing students in the area as demonstrated by annual state assessments in Math, Science and English Language Arts. Mr. Karl is very thankful for the amazing staff of teachers who will be leading and guiding our classrooms this fall. We have such a unique and diverse blend of leaders, assistants and administrators all of whom love children and work hard to ensure they learn and grow in a safe environment.",
      "When Mr. Karl finds free time, he enjoys spending time with his wife Robin and their seven boys, five of whom are either current or former Rising Sun students. Mr. Karl and his family reside in El Dorado Hills.",
    ],
  },
  {
    name: "Susie Carrillo",
    ...
    details: [
      ...
      "Susie has a fiber workshop at her house where she spends hours weaving, knitting, felting, and sewing. She also loves to travel and has been to Chile, Peru, and Spain. Her daughter is a mediator in the fall, winter, and spring months and runs trail crews in the high Sierras in the summer. Susie’s son works as a comedy writer in New York City, with SNL on his resume. They are 9th and 10th generation Californians, whose ancestor walked with Father Serra into Alta-California as a foot soldier.",
      "Susie loves being in the primary classroom because it is foundational to the Montessori Method of education. She has a deep love and respect for the Montessori approach and believes it is THE key to raising a well-balanced individual who knows how to successfully meet the challenges of today’s world. She looks forward to this new school year and all the amazing times with the students.",
    ],
  },
  {
    name: "Supreet Kullar",
  ...
  },
  {
    ...
    details: [
      ...
      "Ms. Maggie has been at Rising Sun since 2017 and she is excited about working with your children this school year.",
    ],
  },
  {
    ...
    details: [
      ...
      "Sumita has been married for over 15 years and has 2 cheerful kids. She enjoys music, dancing, reading, cooking and spending time with family.",
    ],
  },
  {
    name: "Jenn Short",
  ...
  },
  {
    ...
    details: [
      ...
      "As an original founding member of Rising Sun Montessori School, Ms. Robin continues to provide her vast knowledge and support to the classrooms, teachers, students and families by ensuring RSMS provides authentic, meaningful Montessori education to all students.",
    ],
  },
  {
    name: "Amanda Pena",
  ...
  },
  {
    ...
    details: [
      ...
      "Mrs. Mary enjoys travel; she has been to 11 countries and hopes to share some of those cultures in her classroom.  She also enjoys camping, and kayaking. In her spare time, she enjoys crafting, reading books, and playing cards with her family.  She enjoys teaching children reading, math and how to explore the world around them. From day one, Mrs. Mary has been a great addition to our family of talented educators. She looks forward to many more adventures here at Rising Sun Montessori School.",
    ],
  },
  {
    name: "Elissa Moore",
    ...
    details: [
      ...
      "Ms. Elissa functioned as the lead teacher for the 1st-3rd grade levels, a Montessori Mentor, and Teacher Induction Mentor. She loves Montessori because she loves having students for three consecutive years and nurturing long term relationships with families (especially in the case of siblings.) She leaves behind a school community that loved her dearly and strong student/parental relationships.",
      "Ms. Elissa has a deep appreciation for Montessori learning because of its emphasis on hands-on learning, social and emotional growth, and incorporation of leadership and time-management skills starting at an early age. She cultivates a classroom of warmth, comfort, and safety for the children. She facilitates learning through play, experimentation, and experiences.",
      "Ms. Elissa has a home studio where she creates pottery, using her own pottery wheel and kiln.  She has two small dogs that she enjoys taking on long walks. She is an avid reader and loves to cook. Ms. Elissa is close with her family. This includes her father, a pastor, and her mother, a retired teacher. She also has two brothers and a nephew, who is entering 1st grade.",
    ],
  },
  {
    name: "Nick Smith",
