...
const Component = () => {
  return (
    <Layout header="Transitional Kindergarten / Kindergarten">
      <div className="tkMain">
        ...
        <div className="tkDetail">
          <div className="container">
            <p>
              At Rising Sun Montessori, our youngest students grow, learn, and
              thrive in a unique and nurturing environment that lays the
              foundation for a lifelong love of learning.
              <br />
              <br />
              Our Transitional Kindergarten/Kindergarten (TK/K) program is the
              cornerstone of our school, designed to honor the individuality of
              each child. Through the Montessori Method, we embrace the unique
              learning styles and needs of every student, creating a
              personalized experience that fosters confidence, independence, and
              curiosity.
            </p>
            ...
            <div>
              ...
              <p>
                In our Montessori classroom, your child will have the time and
                support to progress at their own pace, mastering skills and
                concepts through hands-on, developmentally appropriate
                activities. Rather than rushing through a variety of tasks, we
                emphasize depth over breadth, allowing children to fully engage
                with and master each activity.
              </p>
